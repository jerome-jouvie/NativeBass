...
/**
 * BASS_Mixer_StreamCreate flags [NAME] BASS_MIXER_FLAGS
 */
public interface BASS_MIXER_FLAGS {
	/** end the stream when there are no sources */
	public static final int BASS_MIXER_END = 0x10000;
	/** don't stall when there are no sources */
	public static final int BASS_MIXER_NONSTOP = 0x20000;
	/** resume stalled immediately upon new/unpaused source */
	public static final int BASS_MIXER_RESUME = 0x1000;
}