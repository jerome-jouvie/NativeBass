 ...
 */
public class _Speakers extends GraphicalGui {
	private static final long serialVersionUID = 1L;
	
	/* display error messages */
	private final void error(String text) {
		JOptionPane.showMessageDialog(_Speakers.this,
	...
	public static void main(String[] args) {
		new BassExampleFrame(new _Speakers());
	}
	...
	@Override
	public String getTitle() { return "BASS Mix - Speakers"; }
