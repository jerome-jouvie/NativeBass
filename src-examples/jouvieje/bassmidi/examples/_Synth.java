 ...
 */
public class _Synth extends GraphicalGui {
	private static final long serialVersionUID = 1L;
	
	/* display error messages */
	private final void error(String text) {
		JOptionPane.showMessageDialog(_Synth.this,
	...
	public static void main(String[] args) {
		new BassExampleFrame(new _Synth());
	}
	...
	@Override
	public String getTitle() { return "BASS Midi - Synth"; }
