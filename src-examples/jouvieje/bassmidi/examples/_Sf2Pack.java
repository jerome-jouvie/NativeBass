 ...
 */
public class _Sf2Pack extends GraphicalGui {
	private static final long serialVersionUID = 1L;
	
	/* display error messages */
	private final void error(String text) {
		JOptionPane.showMessageDialog(_Sf2Pack.this,
	...
	public static void main(String[] args) {
		new BassExampleFrame(new _Sf2Pack());
	}
	...
	@Override
	public String getTitle() { return "BASS Midi - Sf2Pack"; }
