...
package jouvieje.bassmidi.examples;
 ...
 */
public class _MidiTest extends GraphicalGui {
	private static final long serialVersionUID = 1L;
	
	/* display error messages */
	private final void error(String text) {
		JOptionPane.showMessageDialog(_MidiTest.this,
	...
	public static void main(String[] args) {
		new BassExampleFrame(new _MidiTest());
	}
	...
	@Override
	public String getTitle() { return "BASS Midi - Midi Test"; }
