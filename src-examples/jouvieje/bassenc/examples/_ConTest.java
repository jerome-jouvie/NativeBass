...
package jouvieje.bassenc.examples;
 ...
 */
public class _ConTest extends GraphicalGui {
	private static final long serialVersionUID = 1L;
	
	/* display error messages */
	private final void error(String text) {
		JOptionPane.showMessageDialog(_ConTest.this,
	...
	public static void main(String[] args) {
		new BassExampleFrame(new _ConTest());
	}
	...
	@Override
	public String getTitle() { return "BASS Enc - Con Test"; }
