 ...
 */
public class _RecTest extends GraphicalGui {
	private static final long serialVersionUID = 1L;
	
	/* display error messages */
	private final void error(String text) {
		JOptionPane.showMessageDialog(_RecTest.this,
	...
	public static void main(String[] args) {
		new BassExampleFrame(new _RecTest());
	}
	...
	@Override
	public String getTitle() { return "BASS Enc - Rec Test"; }
