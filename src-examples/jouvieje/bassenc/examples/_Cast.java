 ...
 */
public class _Cast extends GraphicalGui {
	private static final long serialVersionUID = 1L;
	
	/* display error messages */
	private final void error(String text) {
		JOptionPane.showMessageDialog(_Cast.this,
	...
	public static void main(String[] args) {
		new BassExampleFrame(new _Cast());
	}
	...
	@Override
	public String getTitle() { return "BASS Enc - Cast"; }
